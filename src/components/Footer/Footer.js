        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            <div
              ...
              style={{ backgroundImage: `url(${yahya})` }}></div>
          </Grid>
          <Grid item xs={12} md={8}>
            <div
              ...
              <p className='about_info'>
                I'm Mohammad yahya, A third year Engineering student, while
                ...
                libraries. I use various tools for designing and styling
                websites such as Figma, Adobe Photoshop, Materialui, Bootstrap,
                SCSS. I believe programming is not about getting a good pay job,
                it's about transforming your ideas into reality and that's what
                set's me apart from others <br></br>
